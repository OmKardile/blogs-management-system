...
export function NavbarDefault() {
    ...
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <p className="flex items-center">
          <Button onClick={gotoMyBlogs}>MyBlogs</Button>
        </p>
      </Typography>
    </ul>
  );
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xxl px-4 py-2 lg:px-8 lg:py-4 mt-10">
        ...
        <div className="flex items-center gap-x-1">
          <div className="ml-8 mr-8">
            ...
            <Button
              size="sm"
              color="white"
              className="ml-20 lg:inline-block right-1 top-1 rounded"
              onClick={logout}
            >
              Log Out
            </Button>
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
          {navList}
          <div className="flex flex-col sm:flex-row items-center gap-x-1">
            {/* <Button
              fullWidth
              variant="text"
              size="sm"
            ...
            <div className="relative w-full gap-2 md:w-max m-3">
              <Input
                type="search"
                placeholder="Search"
                containerProps={{
            ...
            <Button size="md" className="mt-1 rounded-lg sm: -mt-2  ">
              Search
            </Button>
          </div>
        </div>
