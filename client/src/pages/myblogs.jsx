...
export default function Myblogs() {
  return (
    <>
      <section className="flex col-span-2  flex-wrap mx-auto p-10 ">
        <div className="transition-all  duration-150 flex w-full  px-4 py-6 md:w-1/2 lg:w-1/3">
          <div className="flex flex-col items-stretch min-h-full pb-4 mb-5 transition-all duration-150 bg-white rounded-lg shadow-lg hover:shadow-2xl">
